...
export default route.page({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Demandez une réservation chez Indian Coffee à Savigny-le-Temple.",
      },
    ],
  }),
  component: ({
    ...
    <div className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
      <div className="mb-14 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
        ...
        <p className="max-w-xl text-lg text-muted-foreground">
          {reservationNotice} Pour les groupes de plus de 20 personnes, appelez-nous directement.
        </p>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[1.25fr_0.75fr]">
        <Card>
          <CardHeader>
            <CardTitle className="text-3xl">Demande de réservation</CardTitle>
            <CardDescription>
              La demande n’est définitive qu’après réception de notre confirmation.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ReservationForm />
        ...
        <div className="flex flex-col gap-5">
          <Card>
            ...
            <CardContent className="flex flex-col gap-5">
              <a className="flex items-start gap-3" href={`tel:${phone.replace(/\s/g, "")}`}>
              ...
              <a className="flex items-start gap-3" href={mapUrl} rel="noreferrer" target="_blank">
          ...
          >
            <span className="relative flex h-full flex-col justify-between gap-12">
              <span className="font-display text-3xl">Afficher l’itinéraire</span>
